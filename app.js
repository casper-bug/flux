...
async function loadItems() {
  ...
  try {
    ...
    const r = await driveAPI(`https://www.googleapis.com/drive/v3/files?q=${q}&fields=files(id,name,mimeType,size,createdTime,appProperties)&orderBy=createdTime desc`);
    items = r.files || [];
    renderItems();
